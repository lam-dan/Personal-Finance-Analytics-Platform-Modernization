...
The service simulates a real-world financial API with mock data for demonstration.
In production, this would connect to actual databases and include authentication.
"""
...
def spending_trends(start_date: str, end_date: str) -> Dict[str, float]:
    ...
    """
    logger.info(f"Calculating spending trends between {start_date} and {end_date}")
