...
class TestScalaConversions:
    ...
    def test_collection_methods(self):
        ...
        expected = {5: ["apple"], 6: ["banana", "cherry"], 4: ["date"], 10: ["elderberry"]}
    ...
    def test_pattern_matching_financial(self):
        ...
        groceries_tx = FinancialTransaction(1, -120.50, "Groceries", "2024-07-01")
        entertainment_tx = FinancialTransaction(4, -45.30, "Entertainment", "2024-07-07")
        
        assert categorize_transaction(salary_tx) == "Income"
        assert categorize_transaction(groceries_tx) == "Essential Expense"
        assert categorize_transaction(entertainment_tx) == "Discretionary Expense"
