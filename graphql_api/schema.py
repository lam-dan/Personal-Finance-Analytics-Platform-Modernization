...
This module defines the GraphQL schema for the personal finance analytics platform.
It provides a unified interface for querying financial data including transactions
and investments using GraphQL's type-safe query language.
