...
This module handles the migration of financial data from PostgreSQL to
TimescaleDB. It demonstrates a real-world data migration scenario where
legacy data is moved to a modern time-series database for enhanced
